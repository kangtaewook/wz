 ...
 */
public class RippleViewWithImageView extends ImageView{

    private static final String tag = RippleViewWithImageView.class.getSimpleName();
    ...
    public RippleViewWithImageView(Context context)
    {
        super(context);
        initPaint();
        initAnimation();
    ...
    public RippleViewWithImageView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initPaint();
        initAnimation();
    ...
    public RippleViewWithImageView(Context context, AttributeSet attrs, int defStyleAttr)
    {
...
//        }
        ...
        mCenterX = mMinSize / 2;
        mCenterY = mMinSize / 2;
        mRadius = Math.max(mMinSize, mMinSize) / 2;

        Log.d(tag, "ripple out view radius = " + mRadius + "; width =" + mMinSize
                + "; height = " + mMinSize);
