...
public class TouchImageView extends ImageView {
  ...
  //CKY
    public interface OnScaleChangedListener
    {
    	...
    	void onScaleonDoubleTap();
    }

    public float getScale() { return normalizedScale; }
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScaleBegin(ScaleGestureDetector detector) {
            ...
            //com.androidfuse.Library.UTIL.SDSLog.d("onScaleBegin");
            return true;
        }

        @Override
        public boolean onScale(ScaleGestureDetector detector) {
        	//com.androidfuse.Library.UTIL.SDSLog.d("onScale");
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
        	...
        	//com.androidfuse.Library.UTIL.SDSLog.d("onScaleEnd");
        	...
        	if( scaleChangedListener != null )
        		scaleChangedListener.onScaleChanged(normalizedScale);
        }
    }
    ...
    private void scaleImage(float deltaScale, float focusX, float focusY, boolean stretchImageToSuper) {
    	...
    	//com.androidfuse.Library.UTIL.SDSLog.d("scaleImage:"+deltaScale);
    ...
    private class DoubleTapZoom implements Runnable {
    	...
    	DoubleTapZoom(float startZoom, float targetZoom, float focusX, float focusY, boolean stretchImageToSuper) {
    		...
    		TouchImageView.this.scaleChangedListener.onScaleonDoubleTap();
    	}
