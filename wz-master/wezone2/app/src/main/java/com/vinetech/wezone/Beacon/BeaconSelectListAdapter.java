...
public class BeaconSelectListAdapter extends BaseAdapter {
    ...
    public BeaconSelectListAdapter(BaseActivity a, ArrayList<Data_Beacon> userInfos){
        mActivity = a;
        mListItem = userInfos;
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if(convertView == null) {
            convertView = mInflater.inflate(R.layout.beacon_select_list_item, null);
        ...
        holder.linearlayout_btn_check.setSelected(beaconInfo.isSelected);
