...
public class RippleArcView extends View {
    ...
    private static final String tag = RippleArcView.class.getSimpleName();

    private static final int DEFAULT_RIPPLE_COLOR = Color.rgb(0xff, 0xff, 0xff);
    private int mRippleColor = DEFAULT_RIPPLE_COLOR;
    private int mMinSize = 200;
    private boolean animationRunning = false;

    private int currentProgress = 0;
    private int mRippleNum = 5;
    ...
    public RippleArcView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
        initPaint();
        initAnimation();
    ...
    public RippleArcView(Context context, AttributeSet attrs, int defStyleAttr)
    {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec)
    {
        ...
        mCenterY = resultHeight - (resultHeight / 5);
    ...
    public void onDraw(Canvas canvas)
    {
        for (int i = 0; i < mRippleNum; i++)
        {
            ...
            mPaint.setAlpha(150 - 150 * progress / 100);
