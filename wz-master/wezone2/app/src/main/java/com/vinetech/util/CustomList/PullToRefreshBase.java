 ...
 *******************************************************************************/
package com.vinetech.util.CustomList;
...
import com.vinetech.util.CustomList.Lib.FlipLoadingLayout;
import com.vinetech.util.CustomList.Lib.ILoadingLayout;
import com.vinetech.util.CustomList.Lib.LoadingLayout;
import com.vinetech.util.CustomList.Lib.LoadingLayoutProxy;
import com.vinetech.util.CustomList.Lib.RotateLoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private boolean mIsScrollMove = true;
	...
	public void setScrollMove(boolean isScrollMove){
		this.mIsScrollMove = isScrollMove;
	}
	public boolean IsScrollMove(){
		return this.mIsScrollMove;
	}
	...
	protected final void setHeaderScroll(int value) {
		...
		if (USE_HW_LAYERS) {
			 ...
			 */
//			ViewCompat.setLayerType(mRefreshableViewWrapper, value != 0 ? View.LAYER_TYPE_HARDWARE: View.LAYER_TYPE_NONE, null);
		}
